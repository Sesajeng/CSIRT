...
<div class="header">
    <header class="bg-orange-800 py-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="space-x-4">
                <a href="{{ route('welcome') }}" class="hover:underline"  button onclick="responsiveVoice.speak('Home');" 
      ...
      <div class="card-container" >
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text"> 2024-01-10 13:49:27 | https://thehackernews.com/2023/12/new-rugmi-malware-loader-surges-with.html</p>
                <p class="card-text"> Malware loader baru bernama Rugmi digunakan oleh pelaku ancaman untuk menyebarkan pencuri informasi seperti Lumma Stealer, Vidar, RecordBreaker, dan Rescoms. Perusahaan keamanan siber ESET melacak trojan ini dengan nama Win/TrojanDownloader.Rugmi,</p>
                <a href="#" class="btn btn-primary">SELENGKAPNYA</a>
            </div>
        </div>
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                <h5 class="card-title"> Barracuda Memperbaiki Kerentanan Baru ESG Zero-Day yang Dieksploitasi Oleh Kelompok Peretas UNC4841</h5>
                <p class="card-text"> 2024-01-10 13:48:18 | idsirtii.or.id</p>
                <p class="card-text"> Email Security Gateways (ESG) pada Barracuda Networks kembali menjadi korban eksploitasi para peretas yang menyalahgunakan kerentanan zero-day pada open-source library untuk memproses file Excel. Kerentanan yang diidentifikasi sebagai CVE-2023-710</p> 
                <a href="#" class="btn btn-primary">SELENGKAPNYA</a>
            </div>
        </div>
      </div>
    ...
    <script>
        ...
        button.addEventListener('click', () => {
            ...
            if (isPlaying && isHovering) {
                responsiveVoice.speak('Mode Suara');
            }
        });
        ...
        button.addEventListener('mouseover', () => {
            isHovering = true;
            if (isPlaying) {
                responsiveVoice.speak('Mode Non Suara');
            }
        });
